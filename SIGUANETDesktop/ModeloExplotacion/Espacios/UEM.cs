...
namespace SIGUANETDesktop.ModeloExplotacion.Espacios
{
	...
	{
		private string _descripcion = "Unidad Espacial Modificable";
		...
		public UEM(string descripcion, MultiPolygon geometria)
		{
			_descripcion = descripcion;
			_geometria = geometria;
		}
		
		public List<PlantaUEM> ObtenerPlantas()
		{
			List<PlantaUEM> r = new List<PlantaUEM>();
			return r;
		}
