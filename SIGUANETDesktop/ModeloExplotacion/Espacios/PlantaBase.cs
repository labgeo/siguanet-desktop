...
{
	/// <summary>
	/// Description of PlantaBase.
	/// </summary>
	public class PlantaBase
		:IUnidadGeoEstadistica
	{
		...
		public PlantaBase(EnumPlantas planta)
		{
			_planta = planta;
		}
		...
		public List<PlantaEdificio> ObtenerPlantasEdificio()
		{
			...
			string sSQL = "SELECT * FROM quest_plantabase_obtenerplantasedificio(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_obtenerestancias(:param1, :param2)";
			object[] aParametros = {uso.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_obtenerestancias(:param1, :param2, :param3)";
			object[] aParametros = {Enum.GetName(typeof(TipoGrupo), grupo.Tipo).ToLower(), grupo.Denominacion, Enum.GetName(typeof(EnumPlantas), this._planta)};
			ds = DBUtils.GetDataSet(dbOrigen.PGSQL, sSQL, aParametros);
			List<Estancia> r = ObjectFactory.generarListaEstancias(ds);
			return r;
		}
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_obtenerestancias(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			ds = DBUtils.GetDataSet(dbOrigen.PGSQL, sSQL, aParametros);
			List<Estancia> r = ObjectFactory.generarListaEstancias(ds);
			return r;
		}
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_obtenerestanciasutiles(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			ds = DBUtils.GetDataSet(dbOrigen.PGSQL, sSQL, aParametros);
			List<Estancia> r = ObjectFactory.generarListaEstancias(ds);
			return r;
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_obtenerestanciasdocentes(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			ds = DBUtils.GetDataSet(dbOrigen.PGSQL, sSQL, aParametros);
			List<Estancia> r = ObjectFactory.generarListaEstancias(ds);
			return r;			
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_obtenerestanciasdocentes(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			ds = DBUtils.GetDataSet(dbOrigen.PGSQL, sSQL, aParametros);
			List<Estancia> r = ObjectFactory.generarListaEstancias(ds);
			return r;
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_obtenerestanciasocupadas(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			ds = DBUtils.GetDataSet(dbOrigen.PGSQL, sSQL, aParametros);
			List<Estancia> r = ObjectFactory.generarListaEstancias(ds);
			return r;			
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_obtenerestanciasocupadas(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			ds = DBUtils.GetDataSet(dbOrigen.PGSQL, sSQL, aParametros);
			List<Estancia> r = ObjectFactory.generarListaEstancias(ds);
			return r;
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_obtenerestanciasocupadas(:param1, :param2, :param3)";
			object[] aParametros = {Enum.GetName(typeof(TipoGrupo), grupo.Tipo).ToLower(), grupo.Denominacion, Enum.GetName(typeof(EnumPlantas), this._planta)};
			ds = DBUtils.GetDataSet(dbOrigen.PGSQL, sSQL, aParametros);
			List<Estancia> r = ObjectFactory.generarListaEstancias(ds);
			return r;
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_obtenerestanciasnoocupadas(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			ds = DBUtils.GetDataSet(dbOrigen.PGSQL, sSQL, aParametros);
			List<Estancia> r = ObjectFactory.generarListaEstancias(ds);
			return r;			
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_obtenerestanciasnoocupadas(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			ds = DBUtils.GetDataSet(dbOrigen.PGSQL, sSQL, aParametros);
			List<Estancia> r = ObjectFactory.generarListaEstancias(ds);
			return r;
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_obtenerestanciasnoocupadas(:param1, :param2, :param3)";
			object[] aParametros = {Enum.GetName(typeof(TipoGrupo), grupo.Tipo).ToLower(), grupo.Denominacion, Enum.GetName(typeof(EnumPlantas), this._planta)};
			ds = DBUtils.GetDataSet(dbOrigen.PGSQL, sSQL, aParametros);
			List<Estancia> r = ObjectFactory.generarListaEstancias(ds);
			return r;
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_obtenerdespachosocupados(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			ds = DBUtils.GetDataSet(dbOrigen.PGSQL, sSQL, aParametros);
			List<Estancia> r = ObjectFactory.generarListaEstancias(ds);
			return r;
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_obtenerdespachosocupados(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			ds = DBUtils.GetDataSet(dbOrigen.PGSQL, sSQL, aParametros);
			List<Estancia> r = ObjectFactory.generarListaEstancias(ds);
			return r;
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_obtenerdespachosnoocupados(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			ds = DBUtils.GetDataSet(dbOrigen.PGSQL, sSQL, aParametros);
			List<Estancia> r = ObjectFactory.generarListaEstancias(ds);
			return r;			
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_obtenerdespachosnoocupados(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			ds = DBUtils.GetDataSet(dbOrigen.PGSQL, sSQL, aParametros);
			List<Estancia> r = ObjectFactory.generarListaEstancias(ds);
			return r;
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_obteneradmonocupados(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			ds = DBUtils.GetDataSet(dbOrigen.PGSQL, sSQL, aParametros);
			List<Estancia> r = ObjectFactory.generarListaEstancias(ds);
			return r;			
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_obteneradmonocupados(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			ds = DBUtils.GetDataSet(dbOrigen.PGSQL, sSQL, aParametros);
			List<Estancia> r = ObjectFactory.generarListaEstancias(ds);
			return r;
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_obteneradmonnoocupados(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			ds = DBUtils.GetDataSet(dbOrigen.PGSQL, sSQL, aParametros);
			List<Estancia> r = ObjectFactory.generarListaEstancias(ds);
			return r;			
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_obteneradmonnoocupados(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			ds = DBUtils.GetDataSet(dbOrigen.PGSQL, sSQL, aParametros);
			List<Estancia> r = ObjectFactory.generarListaEstancias(ds);
			return r;
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numestancias(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numestancias(:param1, :param2)";
			object[] aParametros = {uso.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numestancias(:param1, :param2, :param3)";
			object[] aParametros = {Enum.GetName(typeof(TipoGrupo), grupo.Tipo), grupo.Denominacion, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
				return (long) r;
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numestanciasutiles(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numestanciasutiles(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numestanciasdocentes(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numestanciasdocentes(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numestanciasocupadas(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numestanciasocupadas(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numestanciasocupadas(:param1, :param2, :param3)";
			object[] aParametros = {Enum.GetName(typeof(TipoGrupo), grupo.Tipo).ToLower(), grupo.Denominacion, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numestanciasnoocupadas(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numestanciasnoocupadas(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numestanciasnoocupadas(:param1, :param2, :param3)";
			object[] aParametros = {Enum.GetName(typeof(TipoGrupo), grupo.Tipo).ToLower(), grupo.Denominacion, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numdespachosocupados(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numdespachosocupados(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numdespachosnoocupados(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numdespachosnoocupados(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numadmonocupados(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numadmonocupados(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numadmonnoocupados(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numadmonnoocupados(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_superficie(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_superficie(:param1, :param2)";
			object[] aParametros = {uso.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(double))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_superficie(:param1, :param2, :param3)";
			object[] aParametros = {Enum.GetName(typeof(TipoGrupo), grupo.Tipo), grupo.Denominacion, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(double))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_superficieutil(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(double))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_superficieutil(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(double))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_superficiedocente(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(double))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_superficiedocente(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(double))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_superficieestanciasocupadas(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(double))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_superficieestanciasocupadas(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(double))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_superficieestanciasocupadas(:param1, :param2, :param3)";
			object[] aParametros = {Enum.GetName(typeof(TipoGrupo), grupo.Tipo).ToLower(), grupo.Denominacion, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(double))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_superficieestanciasnoocupadas(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(double))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_superficieestanciasnoocupadas(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(double))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_superficieestanciasnoocupadas(:param1, :param2, :param3)";
			object[] aParametros = {Enum.GetName(typeof(TipoGrupo), grupo.Tipo).ToLower(), grupo.Denominacion, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(double))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_superficiedespachosocupados(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(double))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_superficiedespachosocupados(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(double))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_superficiedespachosnoocupados(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(double))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_superficiedespachosnoocupados(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(double))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_superficieadmonocupados(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(double))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_superficieadmonocupados(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(double))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_superficieadmonnoocupados(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(double))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_superficieadmonnoocupados(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(double))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_ubicaciones(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_ubicaciones(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			List<Ubicacion> r = new List<Ubicacion>();
			ds = DBUtils.GetDataSet(dbOrigen.PGSQL, sSQL, aParametros);
			if (ds.Tables[0].TableName != "Excepcion")
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_ubicaciones(:param1, :param2, :param3)";
			object[] aParametros = {Enum.GetName(typeof(TipoGrupo), grupo.Tipo).ToLower(), grupo.Denominacion, Enum.GetName(typeof(EnumPlantas), this._planta)};
			List<Ubicacion> r = new List<Ubicacion>();
			ds = DBUtils.GetDataSet(dbOrigen.PGSQL, sSQL, aParametros);
			if (ds.Tables[0].TableName != "Excepcion")
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numpersonas(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numpersonas(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numpersonas(:param1, :param2, :param3)";
			object[] aParametros = {Enum.GetName(typeof(TipoGrupo), grupo.Tipo).ToLower(), grupo.Denominacion, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_densidad(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(double))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_densidad(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(double))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_densidad(:param1, :param2, :param3)";
			object[] aParametros = {Enum.GetName(typeof(TipoGrupo), grupo.Tipo).ToLower(), grupo.Denominacion, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(double))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_ubicacionespas(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			List<Ubicacion> r = new List<Ubicacion>();
			ds = DBUtils.GetDataSet(dbOrigen.PGSQL, sSQL, aParametros);
			if (ds.Tables[0].TableName != "Excepcion")
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_ubicacionespas(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			List<Ubicacion> r = new List<Ubicacion>();
			ds = DBUtils.GetDataSet(dbOrigen.PGSQL, sSQL, aParametros);
			if (ds.Tables[0].TableName != "Excepcion")
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_ubicacionespas(:param1, :param2, :param3)";
			object[] aParametros = {Enum.GetName(typeof(TipoGrupo), grupo.Tipo).ToLower(), grupo.Denominacion, Enum.GetName(typeof(EnumPlantas), this._planta)};
			List<Ubicacion> r = new List<Ubicacion>();
			ds = DBUtils.GetDataSet(dbOrigen.PGSQL, sSQL, aParametros);
			if (ds.Tables[0].TableName != "Excepcion")
		...
		public long NumPAS()
		{
			string sSQL = "SELECT * FROM quest_plantabase_numpas(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numpas(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numpas(:param1, :param2, :param3)";
			object[] aParametros = {Enum.GetName(typeof(TipoGrupo), grupo.Tipo).ToLower(), grupo.Denominacion, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_densidadpas(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(double))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_densidadpas(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(double))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_densidadpas(:param1, :param2, :param3)";
			object[] aParametros = {Enum.GetName(typeof(TipoGrupo), grupo.Tipo).ToLower(), grupo.Denominacion, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(double))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_ubicacionespdi(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			List<Ubicacion> r = new List<Ubicacion>();
			ds = DBUtils.GetDataSet(dbOrigen.PGSQL, sSQL, aParametros);
			if (ds.Tables[0].TableName != "Excepcion")
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_ubicacionespdi(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			List<Ubicacion> r = new List<Ubicacion>();
			ds = DBUtils.GetDataSet(dbOrigen.PGSQL, sSQL, aParametros);
			if (ds.Tables[0].TableName != "Excepcion")
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_ubicacionespdi(:param1, :param2, :param3)";
			object[] aParametros = {Enum.GetName(typeof(TipoGrupo), grupo.Tipo).ToLower(), grupo.Denominacion, Enum.GetName(typeof(EnumPlantas), this._planta)};
			List<Ubicacion> r = new List<Ubicacion>();
			ds = DBUtils.GetDataSet(dbOrigen.PGSQL, sSQL, aParametros);
			if (ds.Tables[0].TableName != "Excepcion")
		...
		public long NumPDI()
		{
			string sSQL = "SELECT * FROM quest_plantabase_numpdi(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numpdi(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numpdi(:param1, :param2, :param3)";
			object[] aParametros = {Enum.GetName(typeof(TipoGrupo), grupo.Tipo).ToLower(), grupo.Denominacion, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_densidadpdi(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(double))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_densidadpdi(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(double))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_densidadpdi(:param1, :param2, :param3)";
			object[] aParametros = {Enum.GetName(typeof(TipoGrupo), grupo.Tipo).ToLower(), grupo.Denominacion, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(double))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_ubicacionescargos(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			List<Ubicacion> r = new List<Ubicacion>();
			ds = DBUtils.GetDataSet(dbOrigen.PGSQL, sSQL, aParametros);
			if (ds.Tables[0].TableName != "Excepcion")
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_ubicacionescargos(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			List<Ubicacion> r = new List<Ubicacion>();
			ds = DBUtils.GetDataSet(dbOrigen.PGSQL, sSQL, aParametros);
			if (ds.Tables[0].TableName != "Excepcion")
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numpdicargos(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numpdicargos(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_ubicacionesbecarios(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			List<Ubicacion> r = new List<Ubicacion>();
			ds = DBUtils.GetDataSet(dbOrigen.PGSQL, sSQL, aParametros);
			if (ds.Tables[0].TableName != "Excepcion")
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_ubicacionesbecarios(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			List<Ubicacion> r = new List<Ubicacion>();
			ds = DBUtils.GetDataSet(dbOrigen.PGSQL, sSQL, aParametros);
			if (ds.Tables[0].TableName != "Excepcion")
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_ubicacionesbecarios(:param1, :param2, :param3)";
			object[] aParametros = {Enum.GetName(typeof(TipoGrupo), grupo.Tipo).ToLower(), grupo.Denominacion, Enum.GetName(typeof(EnumPlantas), this._planta)};
			List<Ubicacion> r = new List<Ubicacion>();
			ds = DBUtils.GetDataSet(dbOrigen.PGSQL, sSQL, aParametros);
			if (ds.Tables[0].TableName != "Excepcion")
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numbecarios(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numbecarios(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numbecarios(:param1, :param2, :param3)";
			object[] aParametros = {Enum.GetName(typeof(TipoGrupo), grupo.Tipo).ToLower(), grupo.Denominacion, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_densidadbecarios(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(double))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_densidadbecarios(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(double))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_densidadbecarios(:param1, :param2, :param3)";
			object[] aParametros = {Enum.GetName(typeof(TipoGrupo), grupo.Tipo).ToLower(), grupo.Denominacion, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(double))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_ubicacionesexternos(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			List<Ubicacion> r = new List<Ubicacion>();
			ds = DBUtils.GetDataSet(dbOrigen.PGSQL, sSQL, aParametros);
			if (ds.Tables[0].TableName != "Excepcion")
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_ubicacionesexternos(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			List<Ubicacion> r = new List<Ubicacion>();
			ds = DBUtils.GetDataSet(dbOrigen.PGSQL, sSQL, aParametros);
			if (ds.Tables[0].TableName != "Excepcion")
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_ubicacionesexternos(:param1, :param2, :param3)";
			object[] aParametros = {Enum.GetName(typeof(TipoGrupo), grupo.Tipo).ToLower(), grupo.Denominacion, Enum.GetName(typeof(EnumPlantas), this._planta)};
			List<Ubicacion> r = new List<Ubicacion>();
			ds = DBUtils.GetDataSet(dbOrigen.PGSQL, sSQL, aParametros);
			if (ds.Tables[0].TableName != "Excepcion")
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numexternos(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numexternos(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_numexternos(:param1, :param2, :param3)";
			object[] aParametros = {Enum.GetName(typeof(TipoGrupo), grupo.Tipo).ToLower(), grupo.Denominacion, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(long))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_densidadexternos(:param1)";
			object[] aParametros = {Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(double))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_densidadexternos(:param1, :param2)";
			object[] aParametros = {adscripcion.Codigo, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(double))
			{
		...
		{
			string sSQL = "SELECT * FROM quest_plantabase_densidadexternos(:param1, :param2, :param3)";
			object[] aParametros = {Enum.GetName(typeof(TipoGrupo), grupo.Tipo).ToLower(), grupo.Denominacion, Enum.GetName(typeof(EnumPlantas), this._planta)};
			object r = DBUtils.GetScalar(dbOrigen.PGSQL, sSQL, aParametros);
			if (r.GetType() == typeof(double))
			{
