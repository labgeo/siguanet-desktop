...
{
	/// <summary>
	/// Description of controlArbolActividades.
	/// </summary>
	public partial class controlArbolActividades : UserControl
	{
		...
		public controlArbolActividades(TreeNode n)
		{
			//
		...
		public DelegadoCambiaArbolActividades EventoCambiaEstado;
	...
	public delegate void DelegadoCambiaArbolActividades(estadoModelo estado);	
}
