...
{
	/// <summary>
	/// Description of controlArbolGruposActividad.
	/// </summary>
	public partial class controlArbolGruposActividad : UserControl
	{
		...
		public controlArbolGruposActividad(TreeNode n)
		{
			//
		...
		public DelegadoCambiaArbolGruposActividad EventoCambiaEstado;
	...
	public delegate void DelegadoCambiaArbolGruposActividad(estadoModelo estado);
}
