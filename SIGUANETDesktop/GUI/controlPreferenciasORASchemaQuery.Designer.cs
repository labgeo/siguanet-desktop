...
{
	partial class controlPreferenciasORASchemaQuery
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.gbCatalogoColumnas.TabIndex = 14;
			...
			this.gbCatalogoVistas.TabIndex = 13;
			...
			this.gbCatalogoTablas.TabIndex = 12;
			...
			this.Name = "controlPreferenciasORASchemaQuery";
